...
class Preprocessing():
    ...
    def read_h5ad(cls, filename: Union[Path, str], pr_process:str = "skip"):
        ...
        or ['mt', 'n_cells_by_counts', 'mean_counts', 'log1p_mean_counts', 'pct_dropout_by_counts'] in list(adata.var):
            ...
            return cls._intial(adata) # initial preprocessing as it is required later
    ...
    def filter_cells(adata: AnnData, max_counts: int):
        ...
        sc.pp.filter_cells(adata, max_counts=max_counts) # filter cells with too high counts # doublet
