...
class CoExpression():
    ...
    def module_to_annotation_cor(cls, cor: DataFrame, module: str, figsize: Optional[Tuple[float, float]]=(8,8)):
        ...
        ax.spines['left'].set_visible(False)
        plt.tight_layout()
        f = cls.path_outs+"/plot+M+trait+annotation.pdf"
    ...
    def module_conservation(cls, adata, samples, nPerm, powers):
        ...
        genes_and_modules_df_.plot(kind="bar",y="n_genes", x="Modules", title="Number of genes in MODULES", figsize=(12,6))
